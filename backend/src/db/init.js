...
function statementsFor(client) {
    ...
    return [
        ...
        `CREATE TABLE IF NOT EXISTS law_firms (
            ...
            phone TEXT,
            email TEXT,
            specialties TEXT DEFAULT 'immobilier,foncier',
            daily_legal_fee INTEGER DEFAULT 100,
            is_active INTEGER DEFAULT 1,
            created_at TEXT DEFAULT CURRENT_TIMESTAMP,
            FOREIGN KEY(user_id) REFERENCES users(id)
        )`,
        `CREATE TABLE IF NOT EXISTS law_firm_collaborators (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            firm_id INTEGER,
            full_name TEXT NOT NULL,
        ...
        `CREATE TABLE IF NOT EXISTS legal_documents (
            ...
            created_at TEXT DEFAULT CURRENT_TIMESTAMP,
            FOREIGN KEY(firm_id) REFERENCES law_firms(id),
            FOREIGN KEY(review_id) REFERENCES legal_reviews(id)
        )`,
